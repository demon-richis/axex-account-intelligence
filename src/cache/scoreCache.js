...
function set(userId, data) { const key = String(userId); cache.delete(key); cache.set(key, { data, timestamp: Date.now() }); // Keep score memory bounded for long-running instances.
